    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviews', models.ManyToManyField(blank=True, related_name='ReviewOrganisationModel_reviews', to='reviews.reviewmodel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviews', models.ManyToManyField(blank=True, related_name='ReviewOrganisationDoctorModel_reviews', to='reviews.reviewmodel')),
            ],
        ),
    ]
